...
{
  $Plack::Middleware::DetectMobileBrowsers::VERSION = '0.02';
}
...
=item C<tablets_as_mobile>

Determines if tablets are considered to be mobile devices.
By default they are not; set this param to a true value to change
